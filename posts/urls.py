...
urlpatterns = [
  ...
  path('authors/<str:pk_a>/posts/<str:pk>/likes/', views.PostLikesView.as_view(), name='get_likes'),
  path('authors/<str:pk_a>/posts/<str:pk>/comments/<str:pk_m>/likes/', views.CommentLikesView.as_view(), name='get_comment_likes'),
